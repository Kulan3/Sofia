...
# Display tuning (useful on Jetson)
WINDOW_FLAGS       = "normal"   # normal, autosize, fullscreen, opengl
WINDOW_RESIZE      = (960, 720) # set None to keep native size
WAITKEY_DELAY_MS   = 1          # cv2.waitKey delay per frame
FORCE_WINDOW_THREAD = True      # call cv2.startWindowThread() before showing frames
