...
DETECT_CONF        = 0.45  # confidence threshold
...
# =========================
# VERSION = 1 -> pause while fire present, then continue when lost
# VERSION = 2 -> approach fire, hold nearby for HOLD_SECS, then continue
VERSION            = 2       # set to 1 or 2

# Approach (used in VERSION=2)
...
APPROACH_MAX_STEPS = 15      # fail-safe to avoid infinite approach
HOLD_SECS          = 6.0     # how long to hold near fire before continuing (ver.2)

# Optional recording (set path or None)
VIDEO_SAVE_PATH    = None    # "C:\Users\nutth\Videos\Drone\Fly_Test.mp4" or None
VIDEO_FPS          = 40
VIDEO_CODEC        = "mp4v"